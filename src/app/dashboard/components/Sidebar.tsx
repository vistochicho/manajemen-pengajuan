...
const menuItems:MenuItem[] = [{
  ...
  subMenu: ["Data Progress", "Submissions", "Data Customer", "Approval", "Data Mining"]
},
{
  id:'2',
  name: 'Logout',
...
const Sidebar:React.FC<SidebarProps> = ({isSidebarOpen}) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 z-40 w-64 h-screen pt-16 bg-white border-r border-gray-200 sm:translate-x-0 transition-transform ${isSidebarOpen?'translate-x-0':'-translate-x-full'}`}>
