...
import { PmaForm } from "./components/PmaForm";
    ...
    <div className="bg-white rounded-lg">
      ...
      <form className="p-6">
        <div className="space-y-8">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-2">
                ...
                <div className="mt-2">
                  <div className="flex rounded-lg px-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <input
                      id="username"
                      name="username"
                      type="text"
          ...
          {isSelected && isSelected === "PT" ? <PtForm /> : isSelected === "CV" ? <CvForm /> : isSelected === "PMA" ? <PmaForm /> : <></>}
        </div>
      </form>
    </div>
  );
